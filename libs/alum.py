...
@lru_cache
def _make_user_request(id: str, query_type: str = "memberIdentity") -> Dict[str, Any]:
    params = {
        "q": query_type,
        "memberIdentity": id,
...
def _parse_topline_company(id: str) -> str:
...
def _parse_identity_connection(id: str, identifier: str) -> str:
